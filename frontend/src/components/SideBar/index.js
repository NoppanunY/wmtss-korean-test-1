...
=======
                <button type="button" className="btn btn-primary" onClick={hideSidebar}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x-circle-fill" viewBox="0 0 16 16">
